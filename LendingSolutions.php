     ...
     <div id="services" class="section lb">
        <div class="container">
            <div class="section-title text-center" style="margin-top:50px;">
                <h3 style="color:#8B040B;">Lending Solutions</h3>
                <p style="color:#8B040B;">
                    At CORfinancial, we give Asset Based Lending (ABL) answers for little and average size organizations. An ABL is a made sure about advance margined against resources without the need to demonstrate income.

                    Regardless of whether an association is encountering quickened development, is hoping to gain resources for extension (gear, land, and so on.) or needs all the more working capital, ABL's permit entrepreneurs to take advantage of their organization's resources for creating the money required.

                    At CORfinancial, instead of making fixed boxes or pre-conditions, we address every application as a novel chance to help our customers accomplish their objectives by giving down to earth, adaptable and inventive arrangements dependent on a mix of organization resources, venture worth, and the borrower needs.

                    With an away from the real factors of the business, our answers are individualized and flexible to address our customer's issues.
                </p>
            </div><!-- end title -->
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-6 col-xs-12">
                        <p class="copyright-text" style="color:white;">
                            ...
                            <a href="#" style="color:white">CorFinancialCorp</a>.
                        </p>
                    </div>
