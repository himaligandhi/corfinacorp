...
<body id="page-top" class="politics_version">
    ...
    <nav class="navbar navbar-expand-sm navbar-dark" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="about.php">
                <img class="img-fluid" src="images/logo2.png" alt="" style="height:70px;"/>
            </a>
    ...
    <div class="container text-center">
        <h1 style="margin-top:50px;color:#8B040B; font-weight: 400;">About Us</h1>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="message-box">
                        ...
                        <p style="color:#8B040B; margin-top: 50px; font-size: 1.2em;">
...
The days of the institutional banker understanding your business and financing needs are long gone, leaving SMB’s constantly struggling to address cash flow needs. We understand these cash flow pressures and can assist SMB’s acquiring additional growth financing and/or financial restructuring. With our depth of resources, we not only provide funding solutions but also provide a hands-on approach which helps alleviate some of the stress associated with funding.

 

Although our sweet spot is loans of $100,000 to $5,000,000 we have the capability to syndicate larger loans. Credit is not a major factor in determining an approval; we provide practical, flexible & creative solutions to each client based on assets, enterprise value & borrowing needs.
                        </p>
...
<div class="col-md-6">
    <div class="right-box-pro wow fadeIn" style="margin-top:50px;">
        <img src="images/finacial.jpg" alt="" class="img-fluid img-rounded" style="height: 400px;" id="slide">
    </div><!-- end media -->
</div><!-- end col -->
</div><!-- end row -->
...
<!-- Our Team -->
<div class="container">
    <h1 style="color:#560404;margin-top: 50px;margin-bottom: 30px;text-align: center;">Our Team</h1>
    <div class="row">
            ...
            <div class="profile-card">
                ...
                <div class="profile-content">
                    ...
                    <h2 class="title">Russel Inspektor</a>
                        <span>Director</span>
                        <span>License Mortgage Agent (Lic.M18001101)</span>
                    </h2>
        ...
        <div class="col-md-4">
            <div class="profile-card">
                ...
                <div class="profile-content">
                <a href="eric.php">
                    <h2 class="title">Eric Inspektor</a>
                        <span>Director</span>
                    </h2>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                        <div class="footer-widget">
                            ...
                            <ul>
                                ...
                                <li><a href="CreditApplication.php">Credit Application</a></li>
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-6 col-xs-12">
                        <p class="copyright-text" style="color:white;">
                            ...
                            <a href="about.php" style="color:white">CorFinancialCorp</a>.
                        </p>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <ul class="social-icons">
                            <li><a class="facebook" href="#"><i class="fa fa-facebook facebook-bg"></i></a></li>
